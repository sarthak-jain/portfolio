...
import heroBg from "../assets/developer_hero.png";
          ...
          <div className="sm:text-center lg:text-left">
            ...
            <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
              <div className="mt-3 sm:mt-0 cursor-pointer w-1/2">
                <a
                  href={`${process.env.PUBLIC_URL}/Sarthak-Jain-Resume.pdf`}
                  download
                  className="w-full flex items-center justify-center gap-2 px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-blue-500 hover:bg-blue-200 md:py-4 md:text-lg md:px-10"
                >
                  Resume
